...
<body>
    <div class="container">
        ...
        <div class="d-flex justify-content-end mb-3">
            <a class="btn btn-primary" href="{{ route('products/create') }}"  data-bs-toggle="modal" data-bs-target="#tambahProdukModal">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <form action="{{route('product.destroy', $product->id)}}"  method="POST" style="display:inline">
                        @method('DELETE')
                        @csrf
                        <button class="btn btn-danger btn-sm" onclick="return confirm('Apakah anda yang ingin menghapus produk?')">
                            Hapus
                        </button>
                    </form>
                    </td>
