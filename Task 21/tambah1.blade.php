<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-light">{{__('Tambah Kategori Baru')}}</h2>
    </x-slot> 
<!DOCTYPE html>
<html lang="id">
<head>
...
<body>
    <div class="container">
        ...
        @endif
        <form action="{{route('category_products.store')}}" method="POST"> <div class="form-group">
            @csrf
