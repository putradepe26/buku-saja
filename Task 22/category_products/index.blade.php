...
<body>
    <div class="container">
        ...
        <div class="d-flex justify-content-end mb-3">
            <a class="btn btn-primary" href="{{ route('product-category.tambah') }}" data-bs-target="#tambahKategoriModal">
                ...
                <tbody class="bg-white">
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <a class="btn btn-warning btn-sm btn-action" href="{{ route('category-products-edit') }}" data-bs-toggle="modal" data-bs-target="#editKategoriModal">
                                <i class="fas fa-edit"></i> Edit
                            </a>
                            <form action="{{route('product-category.destroy', $category->id)}}" method="POST" style="display:inline">
                            @csrf
                            @method('DELETE')
                            <button class="btn btn-danger btn-sm btn-action" onclick="return confirm('Apakah anda yakin ingin menghapus?')">
                    ...
                    <tr>
                        ...
                        <td>80</td>
                        <td class="text-center">
                            <a href="{{route('product-category.edit', $category->id)}}" class="btn btn-warning btn-sm btn-action" data-bs-toggle="modal" data-bs-target="#editKategoriModal">
                                <i class="fas fa-edit"></i> Edit
                            </a>
